...
-   Utilize the **countries** spatial dataframe from the rnaturalearth package to perform a spatial join with sdf_earthquake using the **st_is_within_distance** predicate with a 100-kilometer threshold. This will link earthquake IDs that occurred within 100 kilometers of a country's geometry.
...
Magnitude and NST values are mostly clustered around 0-5 and 0-200, respectively. Higer values of magnitudes and NST are observed for continents that had higher counts of earthquakes as seen in the Eurasia and South America regions.
